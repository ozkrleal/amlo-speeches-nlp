...
aurio {data-height=400, data-width = 400}
----------------------------------------------------------------------
...
- In the peaking days of the virus is going to be the only topic that will be covered.
  - *PARTIALLY* TRUE: surprisingly (or not so much)... public health words and health topic are mentioned more frequently the higher the graph is, but then there are days after this that they try to focus the speech on something completely different.
- There must be a strong correlation between the stock market and his speeches.
