...
aurio {data-height=400}
----------------------------------------------------------------------

Using Latent Dirichlet allocation (LDA) for fitting a topic model into the script set, we chose the size of k = 3 to find what would be the top 3 topics. Came out to be pretty straight forward. As a mental exercise one could conceive what could be the topics that come for the words shown in the graph...
Below there is a slider where you can explore which topics were covered by each script. Notice the trend of topic 1 :)

- First one seems to be talking about the health of the people, cases, and hospitals. HEALTH.
- Second one seems to be talking about the government's addressing. LOGISTICS.
- Third one seems to be talking about the people and money and government. ECONOMY.
